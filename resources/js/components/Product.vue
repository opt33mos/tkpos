    ...
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-footer">
          <pagination :data="products" @pagination-change-page="pagination">
      ...
      >
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <form @submit.prevent="editmode ? updateProduct() : SaveProduct()">
...
export default {
  ...
  methods: {
    ...
    pagination(page = 1) {
      axios.get("api/product?page=" + page).then((respponse) => {
        this.products = respponse.data;
      });
    },
  },
};
